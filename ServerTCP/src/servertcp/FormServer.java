...
public class FormServer extends javax.swing.JFrame {
    ...
    private void startServer() {
        new Thread(() -> {
            try {
                ...
                log("Server TCP jalan di port 5000");
                while (true) {
                    java.net.Socket clientSocket = serverSocket.accept();
                    new HandleSocket(this, clientSocket).start();
                }
            } catch (Exception e) {
    ...
    // Dipanggil dari HandleSocket buat nampilin log ke jendela
    public void log(String message) {
        javax.swing.SwingUtilities.invokeLater(() -> taLog.append(message + "\n"));
    }
